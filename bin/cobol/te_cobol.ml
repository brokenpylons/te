...
module X = Spec.Build(functor(Context: Spec.CONTEXT) -> struct
    ...
    let scanner =
      ...
      let level_number_ = R.(opt (codes "+-") * (diff (plus digit) (sixsix_ + eighteight_))) in
      let keyword_ =
        R.(text "ACCEPT" + text "ACCESS" + text "ADD" + text "ADDRESS" + text "ADVANCING" + text "AFTER" + text "ALL" + text "ALPHABET" + text "ALPHABETIC" + text "ALPHABETIC-LOWER" + text "ALPHABETIC-UPPER" + text "ALPHANUMERIC" + text "ALPHANUMERIC-EDITED" + text "ALSO" + text "ALTER" + text "ALTERNATE" + text "AND" + text "ANY" + text "APPLY" + text "ARE" + text "AREA" + text "AREAS" + text "ASCENDING" + text "ASSIGN" + text "AT" + text "AUTHOR" + text "BEFORE" + text "BEGINNING" + text "BLANK" + text "BLOCK" + text "BOTTOM" + text "BY" + text "CALL" + text "CANCEL" + text "CHARACTER" + text "CHARACTERS" + text "CLASS" + text "CLOSE" + text "CODE-SET" + text "COLLATING" + text "COMMA" + text "COMMON" + text "COMPUTE" + text "CONFIGURATION" + text "CONTAINS" + text "CONTENT" + text "CONTINUE" + text "CONVERTING" + text "COPY" + text "CORR" + text "CORRESPONDING" + text "COUNT" + text "CURRENCY" + text "DATA" + text "DATE" + text "DATE-COMPILED" + text "DATE-WRITTEN" + text "DAY" + text "DAY-OF-WEEK" + text "DBCS" + text "DEBUG-ITEM" + text "DEBUGGING" + text "DECIMAL-POINT" + text "DECLARATIVES" + text "DELETE" + text "DELIMITED" + text "DELIMITER" + text "DEPENDING" + text "DESCENDING" + text "DISPLAY" + text "DIVIDE" + text "DIVISION" + text "DOWN" + text "DUPLICATES" + text "DYNAMIC" + text "EBCDIC" + text "EGCS" + text "ELSE" + text "END" + text "END-ADD" + text "END-CALL" + text "END-COMPUTE" + text "END-DELETE" + text "END-DIVIDE" + text "END-EVALUATE" + text "END-IF" + text "END-MULTIPLY" + text "END-OF-PAGE" + text "END-PERFORM" + text "END-READ" + text "END-RETURN" + text "END-REWRITE" + text "END-SEARCH" + text "END-START" + text "END-STRING" + text "END-SUBTRACT" + text "END-UNSTRING" + text "END-WRITE" + text "ENDING" + text "ENTRY" + text "ENVIRONMENT" + text "EOP" + text "EQUAL" + text "ERROR" + text "EVALUATE" + text "EVERY" + text "EXAMINE" + text "EXCEPTION" + text "EXIT" + text "EXTEND" + text "EXTERNAL" + text "FALSE" + text "FD" + text "FILE" + text "FILE-CONTROL" + text "FILLER" + text "FIRST" + text "FOOTING" + text "FOR" + text "FROM" + text "GIVING" + text "GLOBAL" + text "GO" + text "GOBACK" + text "GREATER" + text "HIGH-VALUE" + text "HIGH-VALUES" + text "I-O" + text "I-O-CONTROL" + text "ID" + text "IDENTIFICATION" + text "IF" + text "IN" + text "INDEXED" + text "INITIAL" + text "INITIALIZE" + text "INPUT" + text "INPUT-OUTPUT" + text "INSPECT" + text "INSTALLATION" + text "INTO" + text "INVALID" + text "IS" + text "JUST" + text "JUSTIFIED" + text "KANJI" + text "KEY" + text "LABEL" + text "LEADING" + text "LEFT" + text "LENGTH" + text "LESS" + text "LINAGE" + text "LINAGE-COUNTER" + text "LINE" + text "LINES" + text "LINKAGE" + text "LOCK" + text "LOW-VALUE" + text "LOW-VALUES" + text "MEMORY" + text "MERGE" + text "MODE" + text "MODULES" + text "MORE-LABELS" + text "MOVE" + text "MULTIPLE" + text "MULTIPLY" + text "NATIVE" + text "NEGATIVE" + text "NEXT" + text "NO" + text "NOT" + text "NULL" + text "NULLS" + text "NUMERIC" + text "NUMERIC-EDITED" + text "OBJECT-COMPUTER" + text "OCCURS" + text "OF" + text "OFF" + text "OMITTED" + text "ON" + text "OPEN" + text "OPTIONAL" + text "OR" + text "ORDER" + text "ORGANIZATION" + text "OTHER" + text "OUTPUT" + text "OVERFLOW" + text "PADDING" + text "PAGE" + text "PASSWORD" + text "PERFORM" + text "PIC" + text "PICTURE" + text "POINTER" + text "POSITION" + text "POSITIVE" + text "PROCEDURE" + text "PROCEDURES" + text "PROCEED" + text "PROGRAM" + text "PROGRAM-ID" + text "QUOTE" + text "QUOTES" + text "RANDOM" + text "READ" + text "RECORD" + text "RECORDING" + text "RECORDS" + text "REDEFINES" + text "REEL" + text "REFERENCE" + text "RELATIVE" + text "RELEASE" + text "REMAINDER" + text "REMARKS" + text "REMOVAL" + text "RENAMES" + text "REPLACING" + text "RERUN" + text "RESERVE" + text "RETURN" + text "RETURN-CODE" + text "REVERSED" + text "REWIND" + text "REWRITE" + text "RIGHT" + text "ROUNDED" + text "RUN" + text "SAME" + text "SD" + text "SEARCH" + text "SECTION" + text "SECURITY" + text "SEGMENT-LIMIT" + text "SELECT" + text "SENTENCE" + text "SEPARATE" + text "SEQUENCE" + text "SEQUENTIAL" + text "SET" + text "SHIFT-IN" + text "SHIFT-OUT" + text "SIGN" + text "SIZE" + text "SORT" + text "SORT-CONTROL" + text "SORT-CORE-SIZE" + text "SORT-FILE-SIZE" + text "SORT-MERGE" + text "SORT-MESSAGE" + text "SORT-MODE-SIZE" + text "SORT-RETURN" + text "SOURCE-COMPUTER" + text "SPACE" + text "SPACES" + text "SPECIAL-NAMES" + text "STANDARD" + text "STANDARD-1" + text "STANDARD-2" + text "START" + text "STATUS" + text "STOP" + text "STRING" + text "SUBTRACT" + text "SUPPRESS" + text "SYMBOLIC" + text "SYNC" + text "SYNCHRONIZED" + text "TALLY" + text "TALLYING" + text "TAPE" + text "TEST" + text "THAN" + text "THEN" + text "THROUGH" + text "THRU" + text "TIME" + text "TIMES" + text "TO" + text "TOP" + text "TRAILING" + text "TRUE" + text "UNIT" + text "UNSTRING" + text "UNTIL" + text "UP" + text "UPON" + text "USAGE" + text "USE" + text "USING" + text "VALUE" + text "VALUES" + text "VARYING" + text "WHEN" + text "WHEN-COMPILED" + text "WITH" + text "WORDS" + text "WORKING-STORAGE" + text "WRITE" + text "WRITE-ONLY" + text "ZERO" + text "ZEROES" + text "ZEROS" + text "BINARY" + text "COMP" + text "COMP-1" + text "COMP-2" + text "COMP-3" + text "COMP-4" + text "COMP-5" + text "COMPUTATIONAL" + text "COMPUTATIONAL-1" + text "COMPUTATIONAL-2" + text "COMPUTATIONAL-3" + text "COMPUTATIONAL-4" + text "COMPUTATIONAL-5" + text "DISPLAY" + text "DISPLAY-1" + text "INDEX" + text "PACKED-DECIMAL" + text "POINTER");
      in
      let id_ = R.(diff (letter * star (letter + digit) * star (plus (codes "-_") * plus (letter + digit))) keyword_) in
      Production.[
        make (u, quoted_pseudo_text) R.(text "==" * comp (star any * text "==" * star any) * text "==");
        make (u, id) id_;
